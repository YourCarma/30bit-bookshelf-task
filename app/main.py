...
# Тестовое задание
### Модули сервиса:
* Модуль управления письменныъ материалов пользователей `bookshelf manager`
...
* Репозиторий управления столиками и бронями `app/modules/bookshelf_manager/uow.py`
""",
              lifespan=lifespan
              )
